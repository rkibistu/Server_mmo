...
iSceneObject* SceneManagerAoS::CreateAndAddSceneObject(std::string name, std::string modelId, std::string shaderId, rml::Vector3 position, rml::Vector3 rotation, rml::Vector3 scale, ObjectMovementType movementType, iSceneObject* parent) {
...
iSceneObject* SceneManagerAoS::CreateUsingModel(std::string name, std::string modelId, std::string shaderId, rml::Vector3 position, rml::Vector3 rotation, rml::Vector3 scale, ObjectMovementType movementType, iSceneObject* parent) {
...
iSceneObject* SceneManagerAoS::CreateUsingMesh(std::string name, std::string meshId, std::string shaderId, rml::Vector3 position, rml::Vector3 rotation, rml::Vector3 scale, ObjectMovementType movementType, iSceneObject* parent) {
	unsigned int id = _sceneObjectIdCounter++;
...
LightObject* SceneManagerAoS::CreateAndAddLightObject(std::string name, std::string meshId, std::string shaderId, rml::Vector3 position, rml::Vector3 rotation, rml::Vector3 scale, rml::Vector3 color, ObjectMovementType movementType, iSceneObject* parent) {
	unsigned int id = _sceneObjectIdCounter++;
...
void SceneManagerAoS::RemoveObject(unsigned int id) {
...
void SceneManagerAoS::AddSceneObject(iSceneObject* obj) {
...
void SceneManagerAoS::AddLightObject(LightObject* obj) {
...
void SceneManagerAoS::CreateSceneObjectChild(Model* model, ModelNode* modelNode, iSceneObject* parent) {
	unsigned int id = _sceneObjectIdCounter++;
