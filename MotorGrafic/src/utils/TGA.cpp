...
typedef struct {
    ...
    short _width;						// image width in pixels
...
char* LoadTGA(const char* szFileName, int* _width, int* height, int* bpp) {
    ...
    *bpp = header.bits;
    char* pOutBuffer = new char[header._width * header.height * header.bits / 8];
